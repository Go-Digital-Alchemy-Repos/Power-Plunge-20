...
| File | Purpose |
|------|---------|
| `client/src/admin/cms/generator/assembleLandingPage.ts` | Assembly engine with `PresetOverrides` support |
| `client/src/admin/cms/generator/assembleCampaignPack.ts` | `generateCampaignPack()` with preset option |
| `client/src/pages/admin-cms-generator-campaigns.tsx` | Campaign UI with preset dropdown and badges |
