...
```
POST /api/admin/cms/sections/seed-kits
```
...
| `server/src/routes/admin/cms.router.ts` | Seed endpoint (`POST /sections/seed-kits`) |
| `client/src/pages/admin-cms-generator-landing.tsx` | Generator wizard with sectionRef/detach toggle |
| `docs/19-CMS/04-SECTIONS.md` | Saved Sections documentation |
