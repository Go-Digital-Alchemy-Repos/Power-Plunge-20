...
Every CMS page includes comprehensive SEO controls for search engine optimization and social media sharing.
...
SEO fields are saved alongside block content when using **Save Draft** or **Publish** in the page builder. Both operations send the full SEO data in the `PUT /api/admin/cms/pages/:id` request.
