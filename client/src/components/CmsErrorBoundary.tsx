...
export default class CmsErrorBoundary extends React.Component<Props, State> {
  ...
  componentDidCatch(error: Error, info: React.ErrorInfo) {
    console.error("[CMS] Uncaught error:", error, info.componentStack);
  }
        ...
        <div className="min-h-[400px] flex items-center justify-center bg-slate-900 p-8">
          <div className="max-w-md text-center space-y-4">
            ...
            <p className="text-slate-400 text-sm">
              The CMS module encountered an error. Check the browser console for details.
            </p>
