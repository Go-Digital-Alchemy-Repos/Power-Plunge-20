    ...
    <CmsV2Layout activeNav="settings" breadcrumbs={[{ label: "Settings" }]}>
      <div className="max-w-3xl mx-auto" data-testid="admin-cms-v2-settings-page">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-xl font-bold text-white">CMS v2 Settings</h1>
        ...
        <div className="space-y-4">
          <Card className="bg-gray-900/60 border-gray-800/60">
            <CardContent className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-sm font-medium text-white mb-1">Feature Flag Status</h3>
                  <p className="text-xs text-gray-500 mb-3">
                    CMS v2 is controlled by the <code className="text-cyan-400 bg-gray-800 px-1 py-0.5 rounded text-[11px]">CMS_V2_ENABLED</code> environment variable.
                    When disabled, all CMS v2 features are hidden from the admin navigation.
                  </p>
                  <Badge className="bg-cyan-900/30 text-cyan-400 border-cyan-800 text-xs" data-testid="badge-cms-v2-status">
          ...
          <Card className="bg-gray-900/60 border-gray-800/60">
            <CardContent className="p-5">
              <h3 className="text-sm font-medium text-white mb-1">Theme Token System</h3>
          ...
          <Card className="bg-gray-900/60 border-gray-800/60">
            <CardContent className="p-5">
              <h3 className="text-sm font-medium text-white mb-1">Block Registry</h3>
